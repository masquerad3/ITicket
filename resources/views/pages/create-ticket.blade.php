...
<head>
  ...
  <!-- Page-specific -->
  <link rel="stylesheet" href="assets/css/pages/create-ticket.css">
...
<body>
  <div class="page">
    ...
    <header class="topbar">
      ...
      <div class="topbar-right">
        ...
        <div class="profile-chip" role="button" tabindex="0">
    ...
    <!-- Sidebar -->
    <aside class="slide-menu" aria-label="Main menu">
      <div class="menu-header">
        <button class="menu-close" aria-label="Close menu"><i class='bx bxs-chevron-right-circle'></i></button>
      </div>
      <div class="menu-content">
        <nav class="menu-group">
          ...
          <a class="menu-link active" href="{{ route('create-ticket') }}"><i class='bx bx-plus-circle'></i> Create Ticket</a>
        </nav>
        <nav class="menu-group">
          ...
          <form id="ticketForm" novalidate>
            ...
            <div class="form-grid">
              <div class="field full">
                ...
                <input id="subject" name="subject" type="text" placeholder="Brief summary (e.g., Cannot access email)" required>
              ...
              <div class="field">
                ...
                <input id="location" name="location" type="text" placeholder="Building/Room (e.g., Main 3A)">
              </div>

              <div class="field full">
                <label for="description">Description</label>
                <textarea id="description" name="description" rows="6" placeholder="Describe the issue, steps to reproduce, and any error messages." required></textarea>
                <div class="desc-row">
              ...
              <div class="field full">
                ...
                <div class="radio-row">
                  ...
                  <label class="radio">
                    <input type="radio" name="contact" value="teams">
  ...
  <script src="assets/js/pages/create-ticket.js"></script>
</body>
</html>